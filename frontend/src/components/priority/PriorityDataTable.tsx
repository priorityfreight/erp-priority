...
type PriorityDataTableProps<TData, TValue> = {
...
export function PriorityDataTable<TData, TValue>({
  columns,
  data,
  emptyTitle,
  emptyDescription,
...
}: PriorityDataTableProps<TData, TValue>) {
  ...
  // TanStack Table is the intended engine for ERP-grade tabular workspaces.
  // The React Compiler currently skips memoization around this hook safely.
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTableView
        table={table}
        headClassName="h-12 px-4"
        headerClassName="border-b border-[rgba(144,158,174,0.18)] bg-[rgba(11,31,59,0.04)]"
